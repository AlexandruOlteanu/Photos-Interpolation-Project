...
%! img = double(nn_resize_RGB(img, x, y));
%! ref = double(imread("../tests/ref/nearest/resized1_RGB.png"));
%! R = img(:, :, 1);
%! G = img(:, :, 2);
%! B = img(:, :, 3);
%! R_ref = ref(:, :, 1);
...
%! img = double(nn_resize_RGB(img, x, y));
%! ref = double(imread("../tests/ref/nearest/resized2_RGB.png"));
%! R = img(:, :, 1);
%! G = img(:, :, 2);
%! B = img(:, :, 3);
%! R_ref = ref(:, :, 1);
...
%! img = double(nn_resize_RGB(img, x, y));
%! ref = double(imread("../tests/ref/nearest/resized3_RGB.png"));
%! R = img(:, :, 1);
%! G = img(:, :, 2);
%! B = img(:, :, 3);
%! R_ref = ref(:, :, 1);
...
%! img = double(nn_resize_RGB(img, x, y));
%! ref = double(imread("../tests/ref/nearest/resized4_RGB.png"));
%! R = img(:, :, 1);
%! G = img(:, :, 2);
%! B = img(:, :, 3);
%! R_ref = ref(:, :, 1);
...
%! img = double(nn_resize_RGB(img, x, y));
%! ref = double(imread("../tests/ref/nearest/resized5_RGB.png"));
%! R = img(:, :, 1);
%! G = img(:, :, 2);
%! B = img(:, :, 3);
%! R_ref = ref(:, :, 1);
